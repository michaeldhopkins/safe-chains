...
- **clean**: Flags: --doc, --dry-run, --frozen, --help, --locked, --offline, --release, --workspace, -h, -n, -q, -r, -v. Valued: --color, --config, --lockfile-path, --manifest-path, --package, --profile, --target, --target-dir, -Z, -p
...
- **config get**: Flags: --frozen, --help, --locked, --offline, --show-origin, -h, -q, -v. Valued: --color, --config, --format, --merged, -Z
...
- **fetch**: Flags: --frozen, --help, --locked, --offline, -h, -q, -v. Valued: --color, --config, --lockfile-path, --manifest-path, --target, -Z
...
- **publish** (requires --dry-run, -n): Flags: --all-features, --allow-dirty, --dry-run, --frozen, --help, --keep-going, --locked, --no-default-features, --no-verify, --offline, --workspace, -h, -n, -q, -v. Valued: --color, --config, --exclude, --features, --index, --jobs, --lockfile-path, --manifest-path, --package, --registry, --target, --target-dir, -F, -Z, -j, -p
- **read-manifest**: Flags: --frozen, --help, --locked, --offline, -h, -q, -v. Valued: --color, --config, --manifest-path
- **report future-incompatibilities**: Flags: --frozen, --help, --locked, --offline, -h, -q, -v. Valued: --color, --config, --id, --package, -Z, -p
- **run**: Flags: --help, -h
...
- **udeps**: Flags: --all, --all-features, --all-targets, --benches, --bins, --examples, --frozen, --help, --keep-going, --lib, --locked, --no-default-features, --offline, --release, --tests, --workspace, --version, -V, -h, -q, -v. Valued: --backend, --bench, --bin, --color, --example, --exclude, --features, --jobs, --manifest-path, --message-format, --output, --package, --profile, --target, --target-dir, --test, -j, -p
...
- **vendor**: Flags: --frozen, --help, --locked, --no-delete, --offline, --respect-source-config, --versioned-dirs, -h, -q, -v. Valued: --color, --config, --lockfile-path, --manifest-path, --sync, -Z, -s
