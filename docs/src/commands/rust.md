...
- **fuzz cmin**: Flags: --all-features, --build-std, --careful, --debug-assertions, --dev, --disable-branch-folding, --help, --no-cfg-fuzzing, --no-default-features, --no-include-main-msvc, --no-trace-compares, --release, --strip-dead-code, --trace-div, --trace-gep, --verbose, --version, -D, -O, -V, -a, -c, -h, -v. Valued: --codegen-units, --features, --fuzz-dir, --sanitizer, --target, --target-dir, -s
- **fuzz coverage**: Flags: --all-features, --build-std, --careful, --debug-assertions, --dev, --disable-branch-folding, --help, --no-cfg-fuzzing, --no-default-features, --no-include-main-msvc, --no-trace-compares, --release, --strip-dead-code, --trace-div, --trace-gep, --verbose, --version, -D, -O, -V, -a, -c, -h, -v. Valued: --codegen-units, --features, --fuzz-dir, --jobs, --llvm-path, --sanitizer, --target, --target-dir, -j, -s
- **fuzz fmt**: Flags: --all-features, --build-std, --careful, --debug-assertions, --dev, --disable-branch-folding, --help, --no-cfg-fuzzing, --no-default-features, --no-include-main-msvc, --no-trace-compares, --release, --strip-dead-code, --trace-div, --trace-gep, --verbose, --version, -D, -O, -V, -a, -c, -h, -v. Valued: --codegen-units, --features, --fuzz-dir, --sanitizer, --target, --target-dir, -s
...
- **fuzz run**: Flags: --all-features, --build-std, --careful, --debug-assertions, --dev, --disable-branch-folding, --help, --no-cfg-fuzzing, --no-default-features, --no-include-main-msvc, --no-trace-compares, --release, --strip-dead-code, --trace-div, --trace-gep, --verbose, --version, -D, -O, -V, -a, -c, -h, -v. Valued: --codegen-units, --features, --fuzz-dir, --jobs, --sanitizer, --target, --target-dir, -j, -s
- **fuzz tmin**: Flags: --all-features, --build-std, --careful, --debug-assertions, --dev, --disable-branch-folding, --help, --no-cfg-fuzzing, --no-default-features, --no-include-main-msvc, --no-trace-compares, --release, --strip-dead-code, --trace-div, --trace-gep, --verbose, --version, -D, -O, -V, -a, -c, -h, -v. Valued: --codegen-units, --features, --fuzz-dir, --runs, --sanitizer, --target, --target-dir, -s
