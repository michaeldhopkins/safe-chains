...
const HANDLED_CMDS: &[&str] = &[
    ...
    "pip", "uv", "poetry", "pyenv", "conda", "coverage", "tox", "nox", "bandit", "pip-audit",
    "cargo", "rustup",
    "go",
    ...
    "dotnet",
    "curl",
    "docker", "podman", "kubectl", "orbctl", "orb", "qemu-img", "helm", "skopeo", "crane", "cosign", "kustomize", "stern", "kubectx", "kubens",
