...
mod tests {
    ...
    safe! {
        ...
        bundle_exec_rake_db_migrate_status: "bundle exec rake db:migrate:status",
        bundle_exec_rake_db_migrate_status_env: "bundle exec rake db:migrate:status RAILS_ENV=test",
        bundle_exec_rake_db_migrate: "bundle exec rake db:migrate",
        bundle_exec_rake_db_migrate_trace: "bundle exec rake db:migrate --trace",
        bundle_exec_rake_db_version: "bundle exec rake db:version",
        bundle_exec_rake_db_create: "bundle exec rake db:create",
        bundle_exec_rake_db_seed: "bundle exec rake db:seed",
        bundle_exec_rake_db_setup: "bundle exec rake db:setup",
        bundle_exec_rake_db_prepare: "bundle exec rake db:prepare",
        bundle_exec_rake_db_schema_load: "bundle exec rake db:schema:load",
        bundle_exec_rake_db_schema_dump: "bundle exec rake db:schema:dump",
        bundle_exec_rake_routes: "bundle exec rake routes",
        bundle_exec_rake_about: "bundle exec rake about",
        bundle_exec_rake_stats: "bundle exec rake stats",
        bundle_exec_rake_log_clear: "bundle exec rake log:clear",
        bundle_exec_rake_tmp_clear: "bundle exec rake tmp:clear",
        bundle_exec_rake_assets_precompile: "bundle exec rake assets:precompile",
        bundle_exec_rake_cache_clear: "bundle exec rake cache:clear",
        bundle_exec_rake_time_zones_local: "bundle exec rake time:zones:local",
        bundle_exec_rake_test: "bundle exec rake test",
        bundle_exec_rake_test_system: "bundle exec rake test:system",
    ...
    denied! {
        ...
        bundle_exec_rake_db_rollback_denied: "bundle exec rake db:rollback",
        bundle_exec_rake_db_reset_denied: "bundle exec rake db:reset",
        bundle_exec_rake_db_purge_denied: "bundle exec rake db:purge",
        bundle_exec_rake_db_migrate_redo_denied: "bundle exec rake db:migrate:redo",
        bundle_exec_rake_unknown_task_denied: "bundle exec rake foo:bar:baz",
        bundle_exec_rake_user_task_denied: "bundle exec rake my_custom_task",
