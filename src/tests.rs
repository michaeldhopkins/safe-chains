...
denied! {
    ...
    xccov_merge: "xccov merge a.xccovreport b.xccovreport",
    xcresulttool_export: "xcresulttool export diagnostics --path Run.xcresult --output-path /tmp/diag",
    xcresulttool_merge: "xcresulttool merge a.xcresult b.xcresult --output-path c.xcresult",
